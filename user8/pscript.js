function sendMessage() {
    ...
    socket.onmessage = function(event) {
      ...
      if (isValidUrl(serverResponse)) {
        ...
        var filePath = "C:/Users/rahim/Desktop/website/personal_assistant_webapp_with_generative_ai/user8/data/" + serverResponse;
        if (fileType === 'image') {
  ...
  function uploadFile(file) {
    ...
    socket.onopen = function(event) {
      ...
      socket.send("user8"); // Replace with appropriate user identifier
